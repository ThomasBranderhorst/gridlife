...
export function run(data, extra) {
  ...
  try {
    const fn = new Function(body + '\n;return {db,_loadFout,_techFout,currentPeriodKey,nextPayday,nextPaydayEff,upcomingPaydays,loonDatesInRange,loonShift,rawNextPayday,rawPaydayAfter,rawPaydayBefore,monthPaydays,manualDates,schoonLoonCfg,feestdagen,feestNaam,pasen,laatsteWerkdag,weekdagInMaand,loonKort,loonDagTekst,loonFreqTekst,loonShiftTekst,loonEntryFor,avgIncome,featOn,potTot,potMonthStatus,potProjectie,potIsMaandelijks,recentePeriodes,potOpzijTeller,gemistePeriodes,potReservering,itemGereserveerd,potPosten,postUit,itemTermijnNetto,toeslagenOf,toeVan,toeVanLog,toeLabel,toeReceived,toeMnd,itToeslagMnd,itMnd,receiptRows,paymentRows,markOccurrence,unmarkOccurrence,skipOccurrence,unskipOccurrence,openTermijnen,vasteTermijnen,zelfdeTermijn,inSchema,raakteSaldo,itemPaid,itemSkipped,itemNextOcc,freqTxt,monthsPer,dateHint,amountHint,hintLogs,loonOffsets,loonDateHint,vandaag,hintDatumZin,afwTekst,loonVerwacht,loonRows,loonHistorieVan,actiefWerk,loonHintRow,dateHintRow,hoofdBaan,hoofdBaanVast,bronWoord,bronActiefWoord,looptEenMaandVoor,potProjectie,BEHEER,zetHoofdBaan,renderBhList,docWarnDays,pdfOnderdelen,loonPerMaand,obGedaan,obVol,confirmOverboek,toggleOverboek,wcSaveDoen,finishOnboarding,backupData,mergeImport,_testSetOb,loonBronnen,loonDagenMetWerk,loonRaster,jsStr,betalingCard,receiptCard,loonCard,renderBetalingen,renderPotjes,renderLoonLog,renderStart,render,go,syncLoonVanWerk,werkCfgOf,save,totalSaldo,potNeed,removeLogEntry,itemSpan,toeSpan,vensterEind,afwijkingDagen,termijnDatumTekst,dichtstbijTermijn,naamSleutel,bestaandeNaam,vrijeNaam,occInfoTekst,potWegAlsLeeg,newPot,hoursOf,occInRange,migrate,geldigeDatum,parseISO,MND,DAG,fmtDur,eur,isoDate};');
    out.api = fn();
